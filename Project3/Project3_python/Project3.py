...
class Plotter:
	...
	def Plot_results(self):
		...
		ax1 = plt.subplot(111)
		plt.hold("on")
		ax1.plot(self.x_t, self.Phi[0][0]/self.Phi[0][0][0], label=r'$k = %.1f H_0/c$' %(self.k[0]*c/H_0))
		ax1.plot(self.x_t, self.Phi[4][0]/self.Phi[4][0][0], label=r'$k = %.1f H_0/c$' %(self.k[4]*c/H_0))
		ax1.plot(self.x_t, self.Phi[50][0]/self.Phi[50][0][0], label=r'$k = %.1f H_0/c$' %(self.k[50]*c/H_0))
		ax1.plot(self.x_t, self.Phi[70][0]/self.Phi[70][0][0], label=r'$k = %.1f H_0/c$' %(self.k[70]*c/H_0))
		ax1.plot(self.x_t, self.Phi[-5][0]/self.Phi[-5][0][0], label=r'$k = %.1f H_0/c$' %(self.k[-5]*c/H_0))
		ax1.plot(self.x_t, self.Phi[-1][0]/self.Phi[-1][0][0], label=r'$k = %.1f H_0/c$' %(self.k[-1]*c/H_0))
