...
class Plotter:
	...
	def Plot_results(self):
		...
		ax3 = plt.subplot(111)
		plt.hold("on")
		ax3.plot(self.x_t, self.delta[0][0], label='$k = %.1f H_0/c$' %(self.k[0]*c/H_0))
		ax3.plot(self.x_t, self.delta[4][0], label='$k = %.1f H_0/c$' %(self.k[4]*c/H_0))
		ax3.plot(self.x_t, self.delta[50][0], label='$k = %.1f H_0/c$' %(self.k[50]*c/H_0))
		ax3.plot(self.x_t, self.delta[70][0], label='$k = %.1f H_0/c$' %(self.k[70]*c/H_0))
		ax3.plot(self.x_t, self.delta[-5][0], label='$k = %.1f H_0/c$' %(self.k[-5]*c/H_0))
		ax3.plot(self.x_t, self.delta[-1][0], label='$k = %.1f H_0/c$' %(self.k[-1]*c/H_0))
		...
		ax4 = plt.subplot(111)
		plt.hold("on")
		ax4.plot(self.x_t, self.deltab[0][0], label='$k = %.1f H_0/c$' %(self.k[0]*c/H_0))
		ax4.plot(self.x_t, self.deltab[4][0], label='$k = %.1f H_0/c$' %(self.k[4]*c/H_0))
		ax4.plot(self.x_t, self.deltab[50][0], label='$k = %.1f H_0/c$' %(self.k[50]*c/H_0))
		ax4.plot(self.x_t, self.deltab[70][0], label='$k = %.1f H_0/c$' %(self.k[70]*c/H_0))
		ax4.plot(self.x_t, self.deltab[-5][0], label='$k = %.1f H_0/c$' %(self.k[-5]*c/H_0))
		ax4.plot(self.x_t, self.deltab[-1][0], label='$k = %.1f H_0/c$' %(self.k[-1]*c/H_0))
