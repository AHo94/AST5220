...
class time_mod():
	def __init__(self):
		...
		self.n_eta = 1000
		self.a_init = 1e-10
		self.x_eta1 = np.log(self.a_init)
		self.x_eta2 = 0

		# Set up grid
		self.x_t = np.linspace(self.x_start_rec, self.X_0, self.n_t)
		self.a_t = np.linspace(self.a_init, 1, self.n_t)	# Scale factor today a_0 = 1
